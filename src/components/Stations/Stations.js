...
const Stations = () => {
  ...
  let stationsInfo;
  !error ? stationsInfo = <p className="loading">Loading...</p> : stationsInfo = <p className="error">Unable to fetch data from API...</p>;
  ...
  return <div className="Stations">{stationsInfo}</div>;
};
